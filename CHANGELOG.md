...
### Fixed
- **Windows:** Split large ExifTool metadata scans into bounded batches, preventing the Windows command-line length limit from blocking folders with many photos.
...
### Fixed
- **macOS:** Find ExifTool in standard Homebrew and MacPorts locations when Finder launches the app with a restricted `PATH`.

### Changed
- **Documentation:** Added macOS installation, Gatekeeper, quarantine, and file-access permission guidance.
